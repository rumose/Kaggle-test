...
\textcolor{red}{According to the ingredient to distinguish food comes from which country.}
}}
...
\begin{figure}[htbp]
  ...
  \centering
  \includegraphics[width=6cm]{D://Code//Kaggle-test//Data//train.eps}
  \caption{train-data}
  \end{minipage}
  \begin{minipage}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=6cm]{D://Code//Kaggle-test//Data//test.eps}
  \caption{test-data}
  \end{minipage}
  \end{figure}
Each training data has three parts:id cuisine ingredients.The features of the foods come form ingredients,
and the training goal is ingredients.
}
% Outlying Aspects Mining
% \begin{itemize}
% \item
...
\begin{figure}[htbp]
  ...
  \begin{minipage}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=6cm]{D://Code//Kaggle-test//Data//cidai.eps}
  \caption{Construct word bag}
  \end{minipage}
  \begin{minipage}[t]{0.48\textwidth}
  \centering
  \includegraphics[width=6cm]{D://Code//Kaggle-test//Data//file.eps}
  \caption{Output}
  \end{minipage}
  \end{figure}
%%==========================================================================================
